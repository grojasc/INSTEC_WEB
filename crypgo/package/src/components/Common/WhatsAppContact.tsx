...
const WhatsAppContact = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-transparent hover:bg-green-50 text-green-600 border-green-500',
    outline: 'bg-transparent hover:bg-green-500 hover:text-white text-green-600 border-green-500'
  };
