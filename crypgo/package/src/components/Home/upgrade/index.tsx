  ...
  return (
    <section className='md:py-40 py-20' id='upgrade'>
      <div className='container px-4'>
        ...
        <div>
          {/* Updated section title and description to communicate benefits */}
          <p className='text-primary sm:text-28 text-18 mb-3'>Beneficios</p>
          <h2 className='text-white sm:text-40 text-30  font-medium mb-5'>
            Eleva tus estándares de calidad
          </h2>
          <p className='text-muted/60 text-18 mb-7'>
            Obtén servicios de inspección rápidos, seguros y a medida, minimizando
            tiempos de inactividad y costos.
          </p>
